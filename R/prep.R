...
#'
#' @param df A dataframe that has values of -999 to represent missing values
...
#'
#' This function accounts for when total pop is 0 - If there is any increase
...
#' @returns A new dataframe with indicated columns log transformed
#'
