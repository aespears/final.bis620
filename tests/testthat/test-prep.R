...
test_that('day_dif works', {
  expect_equal(iris$Sepal.Length - iris$Sepal.Width, day_dif(iris$Sepal.Length, iris$Sepal.Width))
})
...
test_that('log_trans works', {
  expect_equal(nrow(iris), nrow(log_trans(iris, all_of(c('Sepal.Length', 'Sepal.Width',
                                             'Petal.Length','Petal.Width')))))
  expect_equal(ncol(iris), ncol(log_trans(iris, all_of(c('Sepal.Length', 'Sepal.Width',
                                                         'Petal.Length','Petal.Width')))))
})
